...
#install ssh ovpn
wget https://github.com/scp222/mayica/raw/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
wget https://github.com/scp222/mayica/raw/main/sstp.sh && chmod +x sstp.sh && screen -S sstp ./sstp.sh
#installwg
wget https://github.com/scp222/mayica/raw/main/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
#install ssr
